      ...
      <div className="mb-4 py-2 px-8 overflow-x-auto bg-gray-600">
        <div className=" flex gap-x-3 min-w-max  justify-between items-center">
          <form className="flex  gap-2">
            <label htmlFor="billing" class="leading-7 text-sm">Billing</label>
            <input type="text" id="billing" className="w-full bg-gray-700  rounded border border-gray-700 focus:border-indigo-300 focus:bg-transparent text-base outline-none text-gray-100 py-1 px-3" />
          ...
          <div>
            <button className="flex text-white bg-green-600 border-0 py-1 px-4 focus:outline-none hover:bg-green-700 rounded">Add New Bill</button>
          </div>
        </div>
      </div>
