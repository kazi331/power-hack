...
const Register = () => {
  ...
  if (error) {
    if (error.message.includes('auth/email-already-in-us')) {
      error.message = 'Another account exist with this email'
    }
      ...
      <div className="flex h-max mt-20 justify-center items-center">
        <div className="w-96 bg-gray-600 py-10 rounded shadow-xl text-gray-300">
          <div className="text-center">
            <h2 className="text-center font-bold text-2xl mb-2">Register Account</h2>
